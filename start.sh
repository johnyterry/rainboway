...
CONFIGXRY=https://raw.githubusercontent.com/johnyterry/HekuXry/etc/xry.json
...
wget -qO- $CONFIGXRY | sed -e "s/\$AUUID/$AUUID/g" -e "s/\$ParameterSSENCYPT/$ParameterSSENCYPT/g" >/xry.json
